...
<script>
  export default {
    props: ['connexion', 'icon', 'nodisplay', 'scale', 'color'],
    data() {
      return ({
        isConnected: null
      })
